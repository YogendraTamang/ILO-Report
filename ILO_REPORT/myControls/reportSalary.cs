...
{
    public partial class ucReportSalary : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportSalary(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        private void loadData(int fldTypeID) 
        {
            ...
            DataSet ds = bl.GetSalaryChildLabour(cond);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = bl.GetSalaryChildLabour(condition);
            //DataTable dtbl = new DataTable();
            //dtbl.Columns.Add("fldLabourCause");
            if (ds != null && ds.Tables.Count > 0)
            {
