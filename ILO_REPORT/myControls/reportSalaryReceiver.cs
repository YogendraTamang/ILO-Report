...
{
    public partial class ucReportSalaryReceiver : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportSalaryReceiver(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        {
            DataSet ds = bl.GetSalaryReceiverChildLabour(fldTypeID);
