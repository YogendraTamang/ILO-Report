...
{
    public partial class ucReportEducationStatus : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportEducationStatus(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        private void loadData(int fldTypeID) 
        {
            ...
            DataSet ds = bl.GetStudyStateChildLabour(cond);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = bl.GetStudyStateChildLabour(condition);
            if (ds != null && ds.Tables.Count > 0)
            {
                dgridResult.DataSource = ds.Tables[0];
                if (ds.Tables[0].Rows.Count <= 0)
