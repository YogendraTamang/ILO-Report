...
{
    public partial class ucReportEducation_Ka : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportEducation_Ka(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        private void ucEducation_ka_Load(object sender, EventArgs e)
        {
            try
            {
                loadData(pTypeID);
        ...
        private void loadData(int fldTypeID) 
        {
            ...
            DataSet ds = bl.GetEducation(cond);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = bl.GetEducation(condition);
            //DataTable dtbl = new DataTable();
            //dtbl.Columns.Add("fldLabourCause");
            if (ds != null && ds.Tables.Count > 0)
            {
