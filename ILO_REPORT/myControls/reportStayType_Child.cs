...
{
    public partial class ucReportStayTypeChild : UserControl
    {
        ...
        //    InitializeComponent();
        //}
        public ucReportStayTypeChild(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        ...
        private void ucStayTypeChild_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            DataSet ds = bl.GetStayTypeChildLabour(fldTypeID);
