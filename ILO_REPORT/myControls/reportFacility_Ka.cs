...
{
    public partial class ucReportLabourFacility_Ka : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportLabourFacility_Ka(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        {
            DataSet ds = bl.GetFacilityOfChildLabour(fldTypeID);
