...
{
    public partial class ucReportHealthFacility_Ka : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportHealthFacility_Ka(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        {
            DataSet ds = bl.GetHealthFacilityChildLabour(fldTypeID);
