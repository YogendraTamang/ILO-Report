...
{
    public partial class ucReportReligionChild : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        //public ucReportCast_ga()
        //{
        //    InitializeComponent();
        //}
        public ucReportReligionChild(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        ...
        private void ucReligion_ga_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            DataSet ds = bl.GetReligionChildLabour(fldTypeID);
