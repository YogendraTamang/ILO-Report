...
{
    public partial class ucReportLabourLeaveHOme_Ka : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportLabourLeaveHOme_Ka(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        {
            DataSet ds = bl.GetWhyLeaveHomeChildLabour(fldTypeID);
