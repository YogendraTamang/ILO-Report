...
{
    public partial class ucReportLabourType : UserControl
    {
        ...
        //    InitializeComponent();
        //}
        public ucReportLabourType(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        ...
        private void loadData(int fldTypeID) 
        {
            ...
            DataSet ds = bl.GetChildLabourType(cond);
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = bl.GetChildLabourType(condition);
            if (ds != null && ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count <= 0)
                {
