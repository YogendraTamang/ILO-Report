...
{
    public partial class ucReportEducationExpense : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportEducationExpense(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        {
            string cond = pTypeID.ToString();
            DataSet ds = bl.GetStudyExpenseChildLabour(cond);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = bl.GetStudyExpenseChildLabour(condition);
            //DataTable dtbl = new DataTable();
            //dtbl.Columns.Add("fldLabourCause");
            if (ds != null && ds.Tables.Count > 0)
            {
