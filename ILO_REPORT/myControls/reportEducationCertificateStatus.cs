...
{
    public partial class ucReportEducationCertificateStatus : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportEducationCertificateStatus(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        {
            DataSet ds = bl.GetStudyCertificateStateChildLabour(fldTypeID);
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                ...
                {
                    if (dr[0].ToString().Trim() == "0")
                        dr[0] = "छ";
                    else if (dr[0].ToString().Trim() == "1")
                        dr[0] = "छैन";
                }
