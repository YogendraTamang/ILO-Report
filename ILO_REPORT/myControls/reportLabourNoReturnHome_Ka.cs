...
{
    public partial class ucReportLabourNoReturnHOme_Ka : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportLabourNoReturnHOme_Ka(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        }
        ...
        {
            DataSet ds = bl.GetWhyNoReturenHomeChildLabour(fldTypeID);
