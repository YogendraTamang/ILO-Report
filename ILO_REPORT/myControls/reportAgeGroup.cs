...
{
    public partial class ucReportAgeGroup : UserControl
    {
        ...
        //    InitializeComponent();
        //}
        public ucReportAgeGroup(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        ...
        {
            string condition = " and fldTypeID= " + fldTypeID.ToString();
            DataSet ds = bl.GetLabourAgeGroup(condition);
        ...
        {
            string condition = " and fldTypeID=" + pTypeID.ToString();
            ...
            int iStudy = comboStudyState.SelectedIndex;
            if (iStudy == 0)
                condition += " and TSS.fldStudyStateDesc=N'प्राप्त नभएको'";
            else if (iStudy == 1)
                condition += " and TSS.fldStudyStateDesc=N'छ'";
            if (iStudy == 2)
                condition += " and TSS.fldStudyStateDesc=N'छैन'";
            else if (iStudy == 3)
                condition += " and TSS.fldStudyStateDesc=N'छाडेको'";
            else if (iStudy == 4)
                condition += " and TSS.fldStudyStateDesc=N'कहिले नगएको'";
            DataSet ds = bl.GetLabourAgeGroup(condition);
            //DataTable dtbl = new DataTable();
            //dtbl.Columns.Add("fldLabourCause");
            if (ds != null && ds.Tables.Count > 0)
        ...
        private void btnFilterByStudy_Click(object sender, EventArgs e)
        {
