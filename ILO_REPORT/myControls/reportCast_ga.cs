...
{
    public partial class ucReportCast_ga : UserControl
    {
        ...
        //    InitializeComponent();
        //}
        public ucReportCast_ga(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        ...
        private void ucCast_ga_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = bl.GetCast(condition);
            if (ds != null && ds.Tables.Count > 0)
            {
                dgridResult.DataSource = ds.Tables[0];
                if (ds.Tables[0].Rows.Count <= 0)
