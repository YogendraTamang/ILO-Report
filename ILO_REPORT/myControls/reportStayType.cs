...
{
    public partial class ucReportStayType_ga : UserControl
    {
        ...
        //    InitializeComponent();
        //}
        public ucReportStayType_ga(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        ...
        private void ucStayType_ga_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            DataSet ds = bl.GetStayType(fldTypeID);
