...
{
    public partial class ucReportWorkingStart : UserControl
    {
        ...
        //    InitializeComponent();
        //}
        public ucReportWorkingStart(int fldTypeID)
        {
            InitializeComponent();
            pTypeID = fldTypeID;
        ...
        {
            DataSet ds = bl.GetWorkStartTimeChildLabour(fldTypeID);
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                ...
                else
                {
                    ...
                    dtTemp.Columns.Add("काम गर्न थालेको समय (महिना)");
                    ...
                    dtTemp.Rows.Add("0-3 महिना ",to3, ((to3 / total) * 100.0).ToString("0.00"));
                    dtTemp.Rows.Add("4-6 महिना ", to6, ((to6 / total) * 100.0).ToString("0.00"));
                    dtTemp.Rows.Add("7-12 महिना ", to12, ((to12/ total) * 100.0).ToString("0.00"));
                    dtTemp.Rows.Add("13-24 महिना", to24, ((to24 / total) * 100.0).ToString("0.00"));
                    dtTemp.Rows.Add("24 महिना भन्दा बढी", plus24, ((plus24 / total) * 100.0).ToString("0.00"));
