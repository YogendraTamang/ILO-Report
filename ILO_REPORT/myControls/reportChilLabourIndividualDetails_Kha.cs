...
{
    public partial class ucReportCLabourIndividualDetails_Kha : UserControl
    {
        businessClass bl = new businessClass();
        private int pTypeID;
        public ucReportCLabourIndividualDetails_Kha(int fldTypeID)
        {
            pTypeID = fldTypeID;
            InitializeComponent();
        }
        ...
        {
            DataSet ds = bl.GetChildLabourDetails_Kha(" TM.fldTypeID="+fldTypeID.ToString());          
